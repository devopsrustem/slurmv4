...
# Добавить на всех 4 нодах:
export MC_GID_INDEX=3
export MC_TCP_BIND_ADDRESS=10.99.91.X   # RoCE IP конкретной ноды
И расширить device list на обеих сторонах:
bash--disaggregation-ib-device mlx5_0,mlx5_1,mlx5_2,mlx5_3,mlx5_4,mlx5_5,mlx5_6,mlx5_7
Для decode нод (aihub0003/0006) все 8 NIC физические. Для prefill нод (aihub0001/0002) — там другие индексы: mlx5_0,mlx5_3,mlx5_4,mlx5_5,mlx5_6,mlx5_9,mlx5_10,mlx5_11.
Если после этого снова "session not alive" (старая ошибка) вместо краша — значит серверы стартуют, и тогда следующий шаг это NIXL:
