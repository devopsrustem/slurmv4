...
23534980@sigma.sbrf.ru@CAB-WSN-0052363:/home/work/23534980@sigma.sbrf.ru$ ./hey_linux_amd64 -n 200 -c 50 -m POST   -H "Content-Type: application/json"   -d '{"model":"default","messages":[{"role":"user","content":"1+666"}],"max_tokens":12048}'   http://10.82.101.193:8000/v1/chat/completions
