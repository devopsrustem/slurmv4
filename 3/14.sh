...
Process 602459: sglang::scheduler_TP0
Python v3.12.12 (/usr/bin/python3.12)

Thread 602459 (active): "MainThread"
    ...
    forward_decode (model_runner.py:2300)
    _forward_raw (model_runner.py:2488)
    forward (model_runner.py:2401)
    forward_batch_generation (tp_worker.py:456)
    run_batch (scheduler.py:2328)
    event_loop_overlap_disagg_decode (decode.py:943)
    decorate_context (torch/utils/_contextlib.py:120)
    run_scheduler_process (scheduler.py:3184)
    run (multiprocessing/process.py:108)
    _bootstrap (multiprocessing/process.py:314)
    _main (multiprocessing/spawn.py:135)
    spawn_main (multiprocessing/spawn.py:122)
    <module> (<string>:1)
Thread 604142 (idle): "Thread-1"
    wait (threading.py:359)
    wait (threading.py:655)
    run (tqdm/_monitor.py:60)
    _bootstrap_inner (threading.py:1075)
    _bootstrap (threading.py:1032)
Thread 604535 (idle): "Thread-2 (_watchdog_thread)"
    _watchdog_once (utils/watchdog.py:145)
    _watchdog_thread (utils/watchdog.py:125)
    run (threading.py:1012)
    _bootstrap_inner (threading.py:1075)
    _bootstrap (threading.py:1032)
Thread 604585 (idle): "Thread-3 (heartbeat_checker)"
    heartbeat_checker (nixl/conn.py:225)
    run (threading.py:1012)
    _bootstrap_inner (threading.py:1075)
    _bootstrap (threading.py:1032)
Thread 604616 (idle): "InductorSubproc"
